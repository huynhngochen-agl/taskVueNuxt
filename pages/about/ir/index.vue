<template>
     <main id="ir" class="page-second">
            <section class="l-ir1">
                <h2 class="c-title3 text-center"><span>株主・投資家情報</span><small class="mont">Investor Relations</small></h2>
                <figure class="c-mv"><img src="~/assets/img/about/ir/mv.jpg" alt="株主・投資家情報"></figure>
            </section>
            <section class="l-ir2">
